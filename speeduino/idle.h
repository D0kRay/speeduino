...
#define IDLE_PIN_LOW()  digitalWrite(pinIdle1, LOW)//*idle_pin_port &= ~(idle_pin_mask)
#define IDLE_PIN_HIGH() digitalWrite(pinIdle1, HIGH)//*idle_pin_port |= (idle_pin_mask)
#define IDLE2_PIN_LOW()  digitalWrite(pinIdle2, LOW)//*idle2_pin_port &= ~(idle2_pin_mask)
#define IDLE2_PIN_HIGH() digitalWrite(pinIdle2, HIGH)//*idle2_pin_port |= (idle2_pin_mask)
