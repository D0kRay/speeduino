...
#define TACHO_PULSE_HIGH() digitalWrite(pinTachOut, HIGH) //*tach_pin_port |= (tach_pin_mask)
#define TACHO_PULSE_LOW() digitalWrite(pinTachOut, LOW) //*tach_pin_port &= ~(tach_pin_mask)
